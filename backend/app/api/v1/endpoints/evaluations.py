"""
RecoverAI - Evaluations REST API Endpoint Controller (Step 25)

Provides GET /api/v1/evaluations and GET /api/v1/evaluations/{evaluation_id}
for querying historical evaluation run records generated by measurement and simulation runs.
"""
...
async def list_evaluations(
    ...
    """
    Retrieve historical evaluation run records with pagination and mode filtering.
    """
    filters = []
    if mode:
...
async def get_evaluation(
    ...
    """
    Retrieve details of a specific evaluation run by ID.
    """
